...
import com.example.miaoyichao.xpuzzle.adapter.GridPicListAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void popupShow(View view) {
        int desity = (int) ScreenUtil.getDeviceDensity(this);
        mPopupWindow = new PopupWindow(mPopupView, 200 * desity, 50 * desity);
